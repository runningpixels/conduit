...
pub struct ProviderDescriptor {
    ...
    /// 1 = add next (Gemini, Groq, LM Studio, DeepSeek, Mistral),
    /// 2 = Tier A expansion presets (xAI, Z.ai, …), 3 reserved.
    pub tier: u8,
...
pub const PROVIDER_DESCRIPTORS: &[ProviderDescriptor] = &[
    ...
    // Tier A expansion (docs/plans/provider-expansion.md). Every entry below is
    // an `OpenAiPresetAdapter`; ids are keychain keys and are never renamed (D1).
    ProviderDescriptor {
        id: "xai",
        display_name: "xAI",
    ...
    ProviderDescriptor {
        ...
        show_base_url_field: true,
        tier: 2,
        description: Some("Alibaba Model Studio — international endpoint"),
    },
    ProviderDescriptor {
        id: "together",
        ...
        show_base_url_field: true,
        tier: 2,
        description: Some("Open-weight model catalog"),
    },
    ProviderDescriptor {
        id: "fireworks",
